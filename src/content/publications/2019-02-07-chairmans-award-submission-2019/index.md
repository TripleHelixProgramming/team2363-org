---
slug: 2019-02-07-chairmans-award-submission-2019
title: 'Chairman''s Award submission 2019'
date: 2019-02-07
categories:
  - Awards
links:
  ...
  - label: 5957
    url: 'http://cat5cybercanes.org/'
  - label: 1610
    url: 'https://www.blackwaterrobotics.org/'
  - label: community woodworking makerspace
    url: 'http://www.burledandknotted.com/'
  - label: YouTube channel
    url: 'https://www.youtube.com/user/TripleHelix2363/'
  - label: 2018 Gripper Prototype video
    url: 'https://www.youtube.com/watch?v=d-l09rh7EL0'
  - label: DoD STEM
    url: 'https://dodstem.us/'
  - label: SPAWAR
    url: 'https://www.public.navy.mil/spawar/'
  - label: Naval Air Station Oceana Air Show
    url: 'https://www.oceanaairshow.com/'
  - label: NASA Langley’s
    url: 'https://www.nasa.gov/langley/'
  - label: Busch Gardens Williamsburg
    url: 'https://buschgardens.com/williamsburg/'
  - label: Jefferson Lab
    url: 'https://www.jlab.org/'
  - label: Continental Corp.
    url: 'https://www.continental-corporation.com/en-us'
  - label: Junior Woman’s Club of Hilton Village
    url: 'https://www.freewebs.com/jwcnn/'
  - label: Boeing
    url: 'https://www.boeing.com/'
  - label: AFCEA’s HR chapter
    url: 'https://hamptonroads.afceachapters.org/welcome'
  - label: CNU Community STEM Day
    url: 'http://www.pcs.cnu.edu/STEMDay/'
  - label: YMCA STEM Fairs
    url: 'https://www.peninsulaymca.org/our-programs/youth-programs/camp/ymca-stem/'
  - label: VA Air and Space Center
    url: 'https://www.vasc.org/'
  - label: Warwick River Christian School’s
    url: 'http://warwickriver.org/'
  - label: Hines Middle School
    url: 'http://hines.nn.k12.va.us/'
  - label: FRC team 5546’s
    url: 'https://argsrobotics.com/'
  - label: Slack
    url: 'https://slack.com/'
  - label: Cooperating Hampton Roads Organizations for Minorities in Engineering
    url: 'http://www.chrome.org/'
  - label: Lewis Ginter Botanical Garden
    url: 'https://www.lewisginter.org/'
thumbnail: ./IMG_20171012_184750.jpg
---
...
[Rumble in the Roads](https://www.rumbleintheroads.com/), the annual off-season competition we operate with partner teams [5957](http://cat5cybercanes.org/) and [1610](https://www.blackwaterrobotics.org/), is our largest STEM outreach event. Since 2014, we’ve attracted an average of 30 teams from VA, NC, and MD and 300 visitors, including students, parents, mentors, and government figures such as the school’s superintendent and the Vice Mayor of Newport News. This event is an opportunity for teams to practice and train new students before the start of the next build season. In 2018 we supported rookie teams 7429, 7675, and 7715, helping them prepare for the following FRC season by waiving their Rumble competition fees and partnering them with veterans who shared their experience and resources like their drive teams, pit crews, and drivetrains.

In 2018, [Triple Helix established](/publications/2018-09-23-press-release-peninsula-stem-gym-provides-practice-opportunities-for-hampton-roads-youth-robotics-teams/) the Peninsula STEM Gym, which is a shared space that provides a plethora of options for local FIRST teams to explore. Attached to a [community woodworking makerspace](http://www.burledandknotted.com/), the STEM Gym serves as a workshop, practice field, and collaboration space for all levels of FIRST teams. We have a full-size FRC and FTC playing field available for teams to effectively prepare for competitions. Plans are evolving to further expand the use of the space for local FIRST teams.

Our team has maintained a [YouTube channel](https://www.youtube.com/user/TripleHelix2363/) since 2013, where we post tutorials, build season logs, and videos of matches from competitions we attend. These videos are used by FRC teams for drive team development. This past year the team has taken on the task of building an archive of mechanical video tutorials, such as how to build bumpers or a drivetrain, as a way to assist young teams and curious minds alike. We post videos of tested engineering and team practices for the FRC community and provide a long-term visual history of our team. For example, our [2018 Gripper Prototype video](https://www.youtube.com/watch?v=d-l09rh7EL0) gained over 47,000 views and influenced a number of teams’ intakes, such as team 5472, who thanked us for posting it as well as our “contributions to the FIRST community.”

Our sponsors are a part of our identity, and they have a huge impact on how we perform at competitions and in the community. For example, we interacted with over 1,200 visitors when we displayed our robot alongside sponsors [DoD STEM](https://dodstem.us/) and [SPAWAR](https://www.public.navy.mil/spawar/) at the 2016 [Naval Air Station Oceana Air Show](https://www.oceanaairshow.com/) in VA Beach. At [NASA Langley’s](https://www.nasa.gov/langley/) invitation, we demonstrated our robot at their Exploration Days event at [Busch Gardens Williamsburg](https://buschgardens.com/williamsburg/) for over 20,000 park visitors from around the world during each day of the event. We’ve exhibited at NASA’s Youth Day where we were a key part of the experience for NASA employees and their children. In 2016, we partnered with sponsor [Jefferson Lab](https://www.jlab.org/) to host the HR FRC Kickoff; they later commissioned our team to 3D print parts for the GlueX Experiment. In 2017, manufacturing firm [Continental Corp.](https://www.continental-corporation.com/en-us) invited us to tour their facilities and show our robot to their staff. We show our gratitude for our local sponsor, the [Junior Woman’s Club of Hilton Village](https://www.freewebs.com/jwcnn/), by annually supporting their dinner theater event as wait staff. Club members stated “Your students did a wonderful job waiting tables for us at Dinner Theatre!” In July of 2017, NASA and [Boeing](https://www.boeing.com/) invited us to the NASA Langley Centennial Gala; student leaders mingled with industry officials, made professional connections, and participated in a milestone event. Later that summer, we gave a presentation about our team’s strategies and structure to [AFCEA’s HR chapter](https://hamptonroads.afceachapters.org/welcome) at Langley AFB.

Our team regularly works with organizations, businesses, and schools to incorporate FIRST into our region. We annually participate at the [CNU Community STEM Day](http://www.pcs.cnu.edu/STEMDay/) where we demonstrate robot capabilities to 4,500 visitors. Our team has previously run the FRC Summit at CNU, where regional teams share knowledge on topics such as scouting, build season strategies, and off-season projects. We participated in the 2016, 2017, and 2018 [YMCA STEM Fairs](https://www.peninsulaymca.org/our-programs/youth-programs/camp/ymca-stem/) at the [VA Air and Space Center](https://www.vasc.org/), showing our robot to over 1,600 students, local dignitaries, and business leaders.

We sponsor and support several local FIRST teams. During the 2016 and 2017 seasons, we provided mentor help and technical resources to FRC team 5957. We donated critical equipment to [Warwick River Christian School’s](http://warwickriver.org/) FLL team 24104 when they formed in 2016. In 2017 and 2018, we provided mentor support to FLL team 2581. We continue to sponsor [Hines Middle School](http://hines.nn.k12.va.us/) FTC team by funding their registration and competition fees. In 2017, we loaned climbing ropes, mentor support, and mechanical resources to teams that needed them at competitions. Regarding our past support, [FRC team 5546’s](https://argsrobotics.com/) head mentor has stated that
